execute positioned ~ ~1.2 ~ unless entity @e[tag=ariadne_detector,distance=0] run summon armor_stand ~ ~ ~ {Marker:1,Small:1,Invisible:1,Silent:1,NoGravity:1,Tags:[ariadne_detector],ShowArms:1b}
